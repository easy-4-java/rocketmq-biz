...
[![Java](https://img.shields.io/badge/Java-21-orange)](https://github.com/easy-4-java/rocketmq-biz) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](./LICENSE)
...
| disruptor-biz | `3.0.x.x.20260630-SNAPSHOT` (same line)        |
...
```groovy
implementation 'io.github.easy4j:rocketmq-biz:3.0.x.x.20260630-SNAPSHOT'
```
