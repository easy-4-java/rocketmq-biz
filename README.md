...
[![Java](https://img.shields.io/badge/Java-21-orange)](https://github.com/easy-4-java/rocketmq-extension) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](./LICENSE)
...
| disruptor-biz | `3.0.x.20260630-SNAPSHOT` (same line)          |
...
```groovy
implementation 'io.github.easy4j:rocketmq-extension:3.0.x.20260630-SNAPSHOT'
```
...
| `feature/2.0.x` | 17   | `2.0.x.*`       | JDK 17 line                          |
| `feature/3.0.x` | 21   | `3.0.x.*`       | Current branch (RocketMQ 4.5.x)      |
